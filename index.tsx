...
class MainScene extends Phaser.Scene {
    ...
    updateThrusterEmitter() {
        ...
        // FIX: The `setAngle` method is the correct way to update the emitter's angle range.
        // Directly modifying `angle.min` and `angle.max` was causing a type error because
        // TypeScript couldn't guarantee `angle` was an object with those properties.
